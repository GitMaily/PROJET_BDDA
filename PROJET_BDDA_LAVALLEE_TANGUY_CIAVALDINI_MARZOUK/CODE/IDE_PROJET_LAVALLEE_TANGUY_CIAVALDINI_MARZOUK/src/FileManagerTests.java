...
public class FileManagerTests {
	...
	public static RelationInfo creationRelationInfoContexte() {
	...
	public static PageId getFreeDataPageIdTest() {
		RelationInfo rel = creationRelationInfoContexte();
	...
	public static Record creationRecordContexte() {
		RelationInfo rel = creationRelationInfoContexte();
	...
	public static ArrayList<Record> getRecordsInDataPageTest() {
		RelationInfo rel = creationRelationInfoContexte();
		PageId freePage = getFreeDataPageIdTest2();
	...
	public static void getAllDataPagesTest() {
		RelationInfo rel = creationRelationInfoContexte();
	...
	public static void insertRecordInRelTest() {
		Record record = creationRecordContexte();
	...
	public static void main(String[]args) {
		...
		//getFreeDataPageId
		//getFreeDataPageIdTest();
		
		
		//writeRecordToDataPage
		writeRecordToDataPageTest1();
		//writeRecordToDataPageTest2();
